    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
        ...
        <div>
          ...
          {isEditing ? (
            <input
              ...
              className="mt-1 w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-green-500 focus:border-transparent"
            />
          ) : (
        ...
        <div className="md:col-span-2">
          ...
          {isEditing ? (
            <textarea
              ...
              rows="3"
              className="mt-1 w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-green-500 focus:border-transparent resize-none"
            />
          ) : (
            <p className="text-gray-900 dark:text-white font-medium mt-1">
      ...
      <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
        ...
        {isEditing ? (
          ...
          <p className="text-gray-500 text-sm">No working days set</p>
        )}
      </div>
    </div>
  );
