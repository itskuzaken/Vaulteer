...
export default function PostForm({
  ...
  const handleViewImage = (attachment, index) => {
    // Get all image attachments for navigation
    const imageAttachments = formData.attachments.filter((att) => 
  ...
  return (
    <div className="flex justify-center w-full">
                        ...
                        return (
                          ...
                          >
                            ...
                            {isImage ? (
                              ...
                              <div className="flex-shrink-0 w-16 h-16 sm:w-20 sm:h-20 flex items-center justify-center bg-gray-200 dark:bg-gray-800 rounded-lg border-2 border-gray-300 dark:border-gray-600">
                                <IoDocumentOutline className="w-8 h-8 text-red-500" />
                              </div>
                            )}
                            ...
                            <div className="min-w-0 flex-1">
                              ...
                              {isImage && (
                                <button
                                  type="button"
                                  onClick={() => handleViewImage(attachment, index)}
                                  className="text-xs text-red-600 dark:text-red-400 hover:underline mt-1 flex items-center gap-1"
                                >
                            ...
                            <button
                              ...
                              className="text-red-500 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 transition flex-shrink-0 p-1"
                              disabled={isSubmitting}
      ...
      <ImageLightbox
        ...
        imageName={lightboxImage?.originalname || lightboxImage?.filename}
