...
import Navigation from "../../../components/sidebar/StaffSidebar";
...
import StaffOverview from "../../../components/navigation/Overview/StaffOverview";
...
function StaffDashboard() {
  ...
  // Remember last sub-content for each section
  useEffect(() => {
  ...
  // Render logic: show StaffOverview if Overview is selected, else show sub-content or main content
  let ActiveComponent;
  if (selectedContent === "Overview") {
    ActiveComponent = StaffOverview;
  } else if (
    selectedSubContent &&
