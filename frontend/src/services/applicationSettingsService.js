...
export async function getApplicationSettings() {
  try {
    ...
    console.error(
      "[ApplicationSettingsService] Error fetching settings:",
      error
    );
    throw error;
  }
...
export async function openApplications(deadline, idToken) {
  try {
    ...
    if (!response.ok) {
      ...
      throw new Error(
        errorData.message ||
          `Failed to open applications: ${response.statusText}`
      );
    }
    ...
    console.error(
      "[ApplicationSettingsService] Error opening applications:",
      error
    );
    throw error;
  }
...
export async function closeApplications(idToken) {
  try {
    ...
    if (!response.ok) {
      ...
      throw new Error(
        errorData.message ||
          `Failed to close applications: ${response.statusText}`
      );
    }
    ...
    console.error(
      "[ApplicationSettingsService] Error closing applications:",
      error
    );
    throw error;
  }
...
export async function updateDeadline(deadline, idToken) {
  try {
    ...
    if (!response.ok) {
      const errorData = await response.json();
      throw new Error(
        errorData.message || `Failed to update deadline: ${response.statusText}`
      );
    }
    ...
    console.error(
      "[ApplicationSettingsService] Error updating deadline:",
      error
    );
    throw error;
  }
